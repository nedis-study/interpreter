...
public class MinusBinaryCalculator extends AbstractCalculator implements BinaryCalculator {
    private MinusBinaryCalculator(String operator) {
        super(operator);
    }

    public static MinusBinaryCalculator createArithmenticMinusBinaryCalculator(){
        return new MinusBinaryCalculator("-");
    }

    public static MinusBinaryCalculator createAssignmentMinusBinaryCalculator(){
        return new MinusBinaryCalculator("-=");
    }
